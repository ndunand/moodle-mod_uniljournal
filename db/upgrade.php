...
function xmldb_uniljournal_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the uniljournal
     * iself has been upgraded.
     *
     * For each upgrade block, the file uniljournal/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to uniljournal.
        $table = new xmldb_table('uniljournal');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'uniljournal');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        upgrade_mod_savepoint(true, 2007040101, 'uniljournal');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'uniljournal');
    }

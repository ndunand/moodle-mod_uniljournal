...
class article_read extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('article_read_name', 'mod_uniljournal');
    }

    public static function get_explanation() {
        return get_string('article_read_explanation', 'mod_uniljournal');
    }

    public function get_description() {
        return get_string('article_read_desc', 'mod_uniljournal', $this->data['other']);
    }
}

...
$string['element_attachment'] = 'Attachement';
$string['element_title_desc'] = '{$a} title(s)';
$string['element_text_desc'] = '{$a} text(s)';
$string['element_image_desc'] = '{$a} image(s)';
$string['element_attachment_desc'] = '{$a} attachement(s)';
